...
echo "Ficheiro,Processos,Tempo,Mops, Mops/Process" >> intel-nodo_641_16.csv
...
do
  ...
  echo $ficheiro,$processes_clean,$tempo_clean,$mops_clean,$mops_process_clean >> intel-nodo_641_16.csv
done

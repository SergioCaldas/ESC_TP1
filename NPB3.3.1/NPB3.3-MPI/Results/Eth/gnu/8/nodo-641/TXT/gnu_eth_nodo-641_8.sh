...
echo "Ficheiiro,Processos,Tempo,Mops, Mops/Process" >> gnu-nodo_641_8.csv
...
do
  ...
  echo $ficheiro,$processes_clean,$tempo_clean,$mops_clean,$mops_process_clean >> gnu-nodo_641_8.csv
done

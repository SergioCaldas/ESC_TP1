...
Para a realização destes testes foi desenvolvido um \textit{Script} que me permitiu fazer a execução dos testes em lotes com base no sistema PBS. \textbf{FALTA FALAR DA MANEIRA COMO OS DADOS VÃO SER PROCESSADO-GNUPLOT EXCEL SCRIPT}
